...
class constants$78 {
    ...
    static final MethodHandle _calloc_base$MH = RuntimeHelper.downcallHandle(
        "_calloc_base",
        constants$78._calloc_base$FUNC
    );
